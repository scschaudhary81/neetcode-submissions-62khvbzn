/*
Max Heap : Choose from max freq element first
Min Heap : wait Heap with minmum time element is availble move back to max heap
Idea is to after using a character make unavialble time a specified time (k) 
After which we will add it back to max heap
*/
class Solution {
